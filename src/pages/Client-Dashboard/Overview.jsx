...
const editableItems = [
  {
    title: "Hero section",
    description: "Headline, CTAs, stats, and hero images.",
    icon: SparklesIcon,
    route: "/dashboard/landing-page",
  },
  {
    title: "About OHI",
    description: "About text, image, and overlay card.",
    icon: PenToolIcon,
    route: "/dashboard/landing-page",
  },
  {
    title: "Why OHI",
    description: "Section copy, cards, links, and images.",
    icon: Layers3Icon,
    route: "/dashboard/landing-page",
  },
  {
  ...
  {
    title: "Footer",
    description: "Footer text and contact details.",
    icon: Settings2Icon,
    route: "/dashboard/landing-page",
  },
  {
