  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset className="min-h-dvh">
        <SiteHeader />
        <div className="relative mt-4 flex min-h-dvh flex-1 flex-col overflow-hidden bg-[linear-gradient(180deg,#f7fafc_0%,#eef4fb_46%,#e8f0f8_100%)] pt-4 sm:mt-6 sm:pt-6">
