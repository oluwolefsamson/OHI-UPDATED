...
const LeadershipPage = () => {
  return (
    <ProfilePageShell
      ...
      description="OHI is led with a clear institutional purpose: to turn strong production capability into trust, visibility, and decision-ready communication for development and impact audiences."
    ...
    >
      <section className="grid gap-6 lg:grid-cols-[0.92fr_1.08fr]">
        <div className="overflow-hidden rounded-[32px] border border-[#e8dcc8] bg-white shadow-[0_16px_40px_rgba(15,23,42,0.06)]">
        ...
        <div className="rounded-[32px] border border-[#D9DCE2] bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.06)] sm:p-8">
          ...
          <p className="mt-3 text-base leading-7 text-textColor">
            President, Olympian House International
          </p>
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-3">
          {leadershipHighlights.map((item) => (
            <div key={item.title} className="rounded-[28px] border border-[#e8dcc8] bg-white p-6 shadow-[0_12px_28px_rgba(15,23,42,0.06)]">
              ...
              <h3 className="mt-4 text-xl font-semibold text-headingColor">{item.title}</h3>
